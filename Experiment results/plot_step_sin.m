...
for i = 1:10    % positive camber angles
    filename = ['step_response/step',num2str(i),'neg.csv'];
...
filename = ['step_response/step',num2str(0),'.csv'];
step_data{i} = importdata(filename);
nexttile
hold on
plot(step_data{i}(:,6),step_data{i}(:,2))
...
for i = 12:21    % negative camber angles
    filename = ['step_response/step',num2str(i-11),'pos.csv'];
    step_data{i} = importdata(filename);
    nexttile
    hold on
    plot(step_data{i}(:,6),step_data{i}(:,2))
...
sine_data = cell(1,21);
for i = 1:10    % positive camber angles
    filename = ['sinusoidal/sine',num2str(i),'neg.csv'];
...
i=11;   % zero camber angles
filename = ['sinusoidal/sine',num2str(0),'.csv'];
sine_data{i} = importdata(filename);
nexttile
hold on
plot(sine_data{i}(:,6),sine_data{i}(:,2))
...
for i = 12:21    % negative camber angles
    filename = ['sinusoidal/sine',num2str(i-11),'pos.csv'];
    sine_data{i} = importdata(filename);
    nexttile
    hold on
    plot(sine_data{i}(:,6),sine_data{i}(:,2))
...
for j = [1,5,10]    % positive camber angles
    filename = ['step_response/step',num2str(j),'pos.csv'];
